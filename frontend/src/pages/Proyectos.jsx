...
export default function Proyectos() {
    const { user } = useAuth();
    const { setProyectoSlug, navigateToWithProject } = useProyecto();
    ...
    // ============================================================
    // NAVEGAR CON PROYECTO
    // ============================================================
    const irA = (slug, ruta) => {
        if (!slug) {
            console.warn('No se puede navegar sin proyecto');
            return;
        }
        ...
        if (!proyecto) {
            console.warn(`Proyecto "${slug}" no encontrado`);
            return;
        }

        // Usar la función del hook para navegar
        navigateToWithProject(slug, navigate, ruta);
    };
                            ...
                            <div className="proyecto-card-sections">
                                ...
                                {isAnalista && (
                                    <div className="proyecto-section">
                                        ...
                                        <div className="proyecto-section-actions">
                                            <button 
                                                onClick={() => irA(proyecto.slug, '/analisis/cargar')} 
                                            ...
                                            <button 
                                                onClick={() => irA(proyecto.slug, '/analisis/complementar')} 
                                                className="proyecto-action-btn"
                                            >
                                            ...
                                            <button 
                                                onClick={() => irA(proyecto.slug, '/analisis/limpieza')} 
                                                className="proyecto-action-btn"
                                            >
                                ...
                                {isAnalista && (
                                    <div className="proyecto-section">
                                        ...
                                        <div className="proyecto-section-actions">
                                            <button 
                                                onClick={() => irA(proyecto.slug, '/plantillas')} 
                                                className="proyecto-action-btn"
                                            >
                                ...
                                {canEmision && (
                                    <div className="proyecto-section">
                                        ...
                                        <div className="proyecto-section-actions">
                                            <button 
                                                onClick={() => irA(proyecto.slug, '/emision/preparacion')} 
                                                className="proyecto-action-btn"
                                            >
                                            ...
                                            <button 
                                                onClick={() => irA(proyecto.slug, '/emision/emitir')} 
                                                className="proyecto-action-btn"
                                            >
